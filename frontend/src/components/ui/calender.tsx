  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: 'text-sm text-default font-medium',
        ...
        day: 'w-9 h-9 p-0 relative flex items-center justify-center text-sm rounded-md cursor-pointer cursor-pointer',
        ...
        range_middle: 'bg-surface-primary text-default',
        hidden: 'invisible',
        ...classNames,
      }}
      components={{
